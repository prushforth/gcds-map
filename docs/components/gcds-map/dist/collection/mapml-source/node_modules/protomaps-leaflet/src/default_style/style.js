...
import { CenteredTextSymbolizer, CircleSymbolizer, GroupSymbolizer, LineLabelSymbolizer, LineSymbolizer, OffsetTextSymbolizer, PolygonSymbolizer, exp, linear, } from "../symbolizer";
const getString = (props, key) => {
    const val = props[key];
    if (typeof val === "string")
        return val;
    return "";
};
const getNumber = (props, key) => {
    const val = props[key];
    if (typeof val === "number")
        return val;
    return 0;
};
export const paintRules = (t) => {
    return [
        {
            dataLayer: "earth",
