		...
		(function (factory, window) {
		  ...
		  // define an AMD module that relies on 'leaflet'
		  {
		    if (typeof window !== "undefined" && window.L) {
		      ...
		      module.exports = factory(ContextMenu.requireLeafletSrc());
		    }
		  }
...
var LocateControl = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(L_Control_LocateExports);
...
ContextMenu.leafletSrcExports.Map.include({
  ...
  _onFullscreenChange: function (e) {
    var fullscreenElement = ContextMenu.Util.getClosest(this.getContainer(), ':fullscreen'),
      mapEl = ContextMenu.Util.getClosest(this.getContainer(), 'gcds-map');
...
const GcdsMap = class {
    ...
    _setLocale() {
        ...
        if (this.el.closest(':lang(fr)') === this.el) {
            this.locale = ContextMenu.localeFr;
        }
        else if (this.el.closest(':lang(en)') === this.el) {
            this.locale = ContextMenu.locale;
        }
        else {
    ...
    async _ensureControlsLoaded() {
        ...
        try {
            ...
            await Promise.resolve().then(function () { return require('./AttributionButton-DhHK7mSK.js'); });
            // Load ContextMenu handler to register init hooks
            await Promise.resolve().then(function () { return require('./index-CvEoZNXZ.js'); }).then(function (n) { return n.ContextMenu; });
            await Promise.resolve().then(function () { return require('./index-CvEoZNXZ.js'); }).then(function (n) { return n.AnnounceMovement; });
            await Promise.resolve().then(function () { return require('./index-CvEoZNXZ.js'); }).then(function (n) { return n.keyboard; });
            // Load FeatureIndex handler to register init hooks for keyboard navigation
            await Promise.resolve().then(function () { return require('./index-CvEoZNXZ.js'); }).then(function (n) { return n.FeatureIndex; });
...
exports.gcds_map = GcdsMap;
exports.map_layer = GcdsMapLayer;
//# sourceMappingURL=gcds-map.map-layer.entry.cjs.js.map
