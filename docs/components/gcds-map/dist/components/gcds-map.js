import { l as leafletSrcExports, r as requireLeafletSrc, U as Util, p as proxyCustomElement, H, b as localeFr, c as locale } from './index.js';
...
const GcdsMap$1 = /*@__PURE__*/ proxyCustomElement(class GcdsMap extends H {
    ...
    async _ensureControlsLoaded() {
        ...
        try {
            ...
            await import('./p-DkiQO0pB.js');
            // Load ContextMenu handler to register init hooks
            await import('./index.js').then(function (n) { return n.C; });
            await import('./index.js').then(function (n) { return n.A; });
            await import('./index.js').then(function (n) { return n.k; });
            // Load FeatureIndex handler to register init hooks for keyboard navigation
            await import('./index.js').then(function (n) { return n.d; });
    ...
    static get style() { return gcdsMapCss; }
}, [257, "gcds-map", {
        "lat": [1026],
        "lon": [1026],
        "zoom": [1026],
        ...
        "controls": [516],
        "static": [516],
        "_controlslist": [513, "controlslist"],
        "locale": [1032],
        "whenProjectionDefined": [64],
        "whenReady": [64],
        "whenLayersReady": [64]
    }, undefined, {
        "controls": ["controlsChanged"],
...
function defineCustomElement$1() {
    ...
    const components = ["gcds-map"];
    components.forEach(tagName => { switch (tagName) {
        case "gcds-map":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, GcdsMap$1);
            }
            break;
    } });
}
...
const GcdsMap = GcdsMap$1;
const defineCustomElement = defineCustomElement$1;

export { GcdsMap, defineCustomElement };
