...
const MapStyle$1 = /*@__PURE__*/ proxyCustomElement(class MapStyle extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["map-style"];
    components.forEach(tagName => { switch (tagName) {
        case "map-style":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MapStyle$1);
            }
            break;
    } });
}
...
const MapStyle = MapStyle$1;
const defineCustomElement = defineCustomElement$1;

export { MapStyle, defineCustomElement };
