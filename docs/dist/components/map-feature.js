import { p as proxyCustomElement, H, U as Util, M as MapFeatureLayer, f as featureRenderer, l as leafletSrcExports, a as proj4 } from './index.js';
import { c as calculatePosition } from './p-B4YLD_Og.js';

const MapFeature$1 = /*@__PURE__*/ proxyCustomElement(class MapFeature extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["map-feature"];
    components.forEach(tagName => { switch (tagName) {
        case "map-feature":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MapFeature$1);
            }
            break;
    } });
}
...
const MapFeature = MapFeature$1;
const defineCustomElement = defineCustomElement$1;

export { MapFeature, defineCustomElement };
