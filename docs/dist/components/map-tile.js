import { p as proxyCustomElement, H, U as Util } from './index.js';
import { m as mapTileLayer } from './p-DKgl40ry.js';
import { c as calculatePosition } from './p-B4YLD_Og.js';

const MapTile$1 = /*@__PURE__*/ proxyCustomElement(class MapTile extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["map-tile"];
    components.forEach(tagName => { switch (tagName) {
        case "map-tile":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MapTile$1);
            }
            break;
    } });
}
...
const MapTile = MapTile$1;
const defineCustomElement = defineCustomElement$1;

export { MapTile, defineCustomElement };
