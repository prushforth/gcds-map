      ...
      for (let zoom in this._features) {
        for (let k = 0; k < this._features[zoom].length; k++) {
          ...
          if (!renderable) {
            ...
            console.log('MAPML DEBUG: Entering placeholder replacement block', {
              hasLayer: map.hasLayer(geometry),
              hasMap: !!geometry._map,
              leafletId: geometry._leaflet_id,
              parentNode: geometry.defaultOptions.group.parentNode
            });
            ...
            if (geometry.defaultOptions.group.parentNode) {
              ...
              console.log('MAPML DEBUG: Placeholder found:', placeholder);
              if (placeholder) {
