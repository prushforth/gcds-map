...
import * as isVisible from '../../map-layer/test/general/isVisible';
import * as zoomLimit from '../../map-layer/test/general/zoomLimit';
import * as extentProperty from '../../map-layer/test/general/extentProperty';
...
test.describe('Playwright StaticTile Layer Tests', () => {
  isVisible.test('/test/map-tile/staticTileLayer.html', 3, 3);
  zoomLimit.test('/test/map-tile/staticTileLayer.html', 2, 2);
  extentProperty.test('/test/map-tile/staticTileLayer.html', expectedPCRS, expectedGCRS);
  test.describe('General Tests ', () => {
    ...
    test.beforeAll(async () => {
      ...
      await page.goto('/test/map-tile/staticTileLayer.html');
    });
