...
test.describe('Playwright gcds-map fullscreen tests', () => {
  let context, page;
  ...
  test.beforeEach(async () => {
    await page.goto('/test/gcds-map/gcds-map-in-shadow-root.html', { waitUntil: 'networkidle' });
  });
  test('Fullscreen button makes shadow DOM gcds-map element the fullscreen element', async () => {
  ...
  test('Context Menu Fullscreen Button makes shadow DOM gcds-map element fullscreen', async () => {
    const map2 = page.getByTestId('map2');
    await map2.click();
  ...
  test('Fullscreen button makes light DOM gcds-map element the fullscreen element', async () => {
  ...
  test('Context Menu Fullscreen Button light DOM gcds-map element fullscreen', async () => {
    const map3 = page.getByTestId('map3');
    await map3.click();
    await page.keyboard.press('Shift+F10');
    await page.keyboard.press('F');
