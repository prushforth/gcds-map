...
export class GcdsMap {
  ...
  async connectedCallback() {
    ...
    try {
      ...
      // We don't force attribute-based dimensions during init to preserve CSS domination
      ...
      // Set container dimensions to match computed values (don't override host element CSS)
      if (this._container) {
